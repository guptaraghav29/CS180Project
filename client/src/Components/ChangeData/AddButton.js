        ...
        <form onSubmit={handleSubmit}>
          ...
          <DialogContent>
            <TextField
              ...
              value={carBrand}
              onChange={(event) => {
                setBrand(event.target.value.replace(/[0-9]/g, ""));
              }}
              sx={{
            ...
            <TextField
              ...
              value={carOdometer}
              onChange={(event) => {
                setOdometer(event.target.value.replace(/\D/g, ""));
              }}
              sx={{
                "& .MuiOutlinedInput-notchedOutline": {
                  boxShadow: 1,
            ...
            <TextField
              ...
              value={carStatus}
              onChange={(event) => {
                setStatus(event.target.value.replace(/[0-9]/g, ""));
              }}
              sx={{
                "& .MuiOutlinedInput-notchedOutline": {
                  boxShadow: 1,
            ...
            <TextField
              ...
              value={carColor}
              onChange={(event) => {
                setColor(event.target.value.replace(/[0-9]/g, ""));
              }}
              sx={{
                "& .MuiOutlinedInput-notchedOutline": {
                  boxShadow: 1,
            ...
            <TextField
              ...
              value={carRegion}
              onChange={(event) => {
                setRegion(event.target.value.replace(/[0-9]/g, ""));
              }}
              sx={{
                "& .MuiOutlinedInput-notchedOutline": {
                  boxShadow: 1,
