...
function changeStyleAnalytics() {
  ...
  document.getElementById("analytics").style.cssText = 'border-bottom-color: #3B82F6;';
  ...
  document.getElementById("search").style.cssText = 'background: white; color: #3B82F6';
  document.getElementById("adv").style.cssText = 'background: white; color: #3B82F6';
}
function changeStyleSearch() {
  //document.getElementById("search").style.cssText = 'background: #3B82F6; color: white';
  document.getElementById("search").style.cssText = 'border-bottom-color: #3B82F6;';
  //document.getElementById("bar").style.cssText = 'background-image: -webkit-linear-gradient(bottom, #3B82F6 3px, transparent 3px, transparent 3px)';
  document.getElementById("analytics").style.cssText = 'background: white; color: #3B82F6';
  document.getElementById("adv").style.cssText = 'background: white; color: #3B82F6';
}
function changeStyleAdvSearch() {
  document.getElementById("search").style.cssText = 'background: white; color: #3B82F6';
  document.getElementById("analytics").style.cssText = 'background: white; color: #3B82F6';
  document.getElementById("adv").style.cssText = 'border-bottom-color: #3B82F6;';
